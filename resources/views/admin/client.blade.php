    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            <li {{ (isset($list)) ? 'class=active' : '' }}>
                <a href="{{ route('clients.index').qString() }}">
                    <i class="fa fa-list" aria-hidden="true"></i> Client List
                </a>
            </li>

            <li {{ (isset($create)) ? 'class=active' : '' }}>
                <a href="{{ route('clients.create').qString() }}">
            ...
            <li class="active">
                <a href="#">
                    <i class="fa fa-edit" aria-hidden="true"></i> Edit Client
                </a>
            </li>
            @endif
            ...
            <li class="active">
                <a href="#">
                    <i class="fa fa-list-alt" aria-hidden="true"></i> Client Details
                </a>
            </li>
            @endif
        </ul>
        ...
        <div class="tab-content">
                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <th>Image</th>
                            <th>:</th>
                            <td>{!! viewImg('clients', $data->image, ['popup' => 1, 'style' =>'max-width:100%;']) !!}</td>
                        </tr>
                        <tr>
                            <th>Show In Home</th>
                            <th>:</th>
            ...
            <div class="tab-pane active">
                <div class="box-body">
                    <form method="POST" action="{{ isset($edit) ? route('clients.update', $edit) : route('clients.store') }}{{ qString() }}" id="are_you_sure" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                ...
                                <div class="form-group{{ $errors->has('details') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control summernote" name="details" rows="6" required>{{ old('details', isset($data) ? $data->details : '') }}</textarea>
                                ...
                                <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                                    <label class="control-label col-sm-3 {{ isset($edit) ? '' : 'required' }}">Image:(380 by 88)</label>
                                    <div class="col-sm-9">
                            ...
                            <div class="col-sm-4 text-center">
                                {!! viewImg('clients', (isset($data->image)) ? $data->image : '', ['popup' => 1, 'style' =>'width:100%;', 'id' => 'img_preview', 'fake' => 'fake']) !!}
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="box-header text-right">
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn btn-custom btn-flat" href="{{ route('clients.index') }}">X</a>
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered table-hover dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{!! viewImg('clients', $val->image, ['thumb' => 1, 'popup' => 1, 'style' =>'width:30px;', 'fake' => 'fake']) !!}</td>
                                <td>{{ $val->title }}</td>
                                <td>{{ $val->is_home }}</td>
                                <td>{{ $val->status }}</td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="{{ route('clients.show', $val->id).qString() }}"><i class="fa fa-eye"></i> Show</a></li>
                                            <li><a href="{{ route('clients.edit', $val->id).qString() }}"><i class="fa fa-eye"></i> Edit</a></li>
                                            <li><a onclick="deleted('{{ route('clients.destroy', $val->id).qString() }}')"><i class="fa fa-close"></i> Delete</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
