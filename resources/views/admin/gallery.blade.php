    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            <li {{ (isset($list)) ? 'class=active' : '' }}>
                <a href="{{ route('galleries.index').qString() }}">
                    <i class="fa fa-list" aria-hidden="true"></i> Gallery List
                </a>
            </li>

            <li {{ (isset($create)) ? 'class=active' : '' }}>
                <a href="{{ route('galleries.create').qString() }}">
            ...
            <li class="active">
                <a href="#">
                    <i class="fa fa-edit" aria-hidden="true"></i> Edit Gallery
                </a>
            </li>
            @endif
            ...
            <li class="active">
                <a href="#">
                    <i class="fa fa-list-alt" aria-hidden="true"></i> Gallery Details
                </a>
            </li>
            @endif
        </ul>
        ...
        <div class="tab-content">
                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <th>Image</th>
                            <th>:</th>
                            <td>{!! viewImg('galleries', $data->image, ['popup' => 1, 'style' =>'max-width:100%;']) !!}</td>
                        </tr>
                        <tr>
                            <th>Show In Home</th>
                            <th>:</th>
            ...
            <div class="tab-pane active">
                <div class="box-body">
                    <form method="POST" action="{{ isset($edit) ? route('galleries.update', $edit) : route('galleries.store') }}{{ qString() }}" id="are_you_sure" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 text-center">
                                {!! viewImg('galleries', (isset($data->image)) ? $data->image : '', ['popup' => 1, 'style' =>'width:100%;', 'id' => 'img_preview', 'fake' => 'fake']) !!}
                            </div>
                        </div>
                    </form>
                </div>
            ...
            @elseif (isset($list))
            <div class="tab-pane active">
                <form method="GET" action="{{ route('galleries.index') }}" class="form-inline">
                    <div class="box-header text-right">
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn btn-custom btn-flat" href="{{ route('galleries.index') }}">X</a>
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered table-hover dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{!! viewImg('galleries', $val->image, ['thumb' => 1, 'popup' => 1, 'style' =>'width:30px;', 'fake' => 'fake']) !!}</td>
                                <td>{{ $val->title }}</td>
                                <td>{{ $val->is_home }}</td>
                                <td>{{ $val->status }}</td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="{{ route('galleries.show', $val->id).qString() }}"><i class="fa fa-eye"></i> Show</a></li>
                                            <li><a href="{{ route('galleries.edit', $val->id).qString() }}"><i class="fa fa-eye"></i> Edit</a></li>
                                            <li><a onclick="deleted('{{ route('galleries.destroy', $val->id).qString() }}')"><i class="fa fa-close"></i> Delete</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
