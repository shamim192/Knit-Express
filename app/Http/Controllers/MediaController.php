...
class MediaController
{
    ...
    public function imageUpload($requestFile, $path, $thumb = false, $name = null, $imageResize = [], $thumbResize = [85, 48])
    {
        //Path Create...
    ...
    public function thumb($path, $file, $thumbPath = false, $thumbWidth = 85, $thumbHeight = 48)
    {
        $realPath = $this->basePath.$path;
        if (!$thumbPath) {
